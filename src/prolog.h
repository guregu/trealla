...
extern pl_idx_t g_dcg_s, g_throw_s, g_sys_block_catcher_s, g_sys_drop_barrier_s;
extern pl_idx_t g_sys_soft_prune_s, g_if_then_s, g_soft_cut_s, g_negation_s;
...
extern pl_idx_t g_sys_cut_if_det_s, g_as_s, g_colon_s, g_sys_prune_s, g_syscall_s;
